...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function sauvegarderChampProfil(champ, valeur, inputEl, btnEl) {
        const msgEl = document.getElementById('msg-profil');
        ...
        .then(function(data) {
            if (data.succes) {
                ...
                if (msgEl) {
                    msgEl.textContent = '✅ ' + (data.message || 'Modification enregistrée.');
                    msgEl.className = 'msg-profil-succes';
                    if (champ === 'email') {
                ...
                if (msgEl) {
                    ...
                    msgEl.className = 'msg-profil-erreur';
                }
            }
        })
        .catch(function() {
